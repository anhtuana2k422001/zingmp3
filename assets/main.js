        ...
        profile_head_list.onclick = function (){
            ...
            switch(index){
                    case 0:
                        ...
                        // chỉnh lại ablum
                        profile_playlists[1].style.marginTop= '100px';
    ...
    item_animate_forth.style.transform = 'translateX(-840px)'; 
    item_animate_five.style.transform = 'translateX(-830px)'; 
    // item_animate_five.style.transform = 'translateX(0)'; 
    
    
    
    setTimeout(() => {
        setTimeout(() => {
            item_animate_first.style.transform = 'translateX(160px)';  
            ...
            item_animate_forth.style.transform = 'translateX(-496px)'; 
            item_animate_five.style.display = 'block';
            setTimeout(function(){
                item_animate_five.style.transform = 'translateX(-670px)';
            },20)
            // item_animate_five.style.transform =  'rotate(270deg)';
        },3000)
        setTimeout(() => {
            item_animate_first.style.transform = 'translateX(495px)';  
            item_animate_second.style.transform = 'translateX(-175px)';  
            ...
            setTimeout(function(){
                ...
                item_animate_forth.style.transform = 'translateX(-335px)'; 
            },20)
            item_animate_five.style.transform = 'translateX(-1006px)';  
        },6000)
        setTimeout(() => {
            setTimeout(function(){
            ...
            item_animate_second.style.transform = 'translateX(160px)';  
            item_animate_third.style.transform = 'translateX(-512px)';  
            item_animate_third.style.display = 'none';  
            item_animate_forth.style.transform = 'translateX(-671px)'; 
            item_animate_five.style.transform = 'translateX(-1342px)';  
        },9000)
        setTimeout(() => {
                setTimeout(function(){
                ...
                item_animate_third.style.transform = 'translateX(-175px)';  
                item_animate_forth.style.transform = 'translateX(-1006px)'; 
                item_animate_five.style.display = 'none'; 
            },12000)
            setTimeout(() => {
